...
The company is exploring posible future wind energy oportunities in VIC and NSW, Australia, and will require data on a multitude of factors, including:
* baseline costs,  
* expected energy outputs, 
* outage hisotoy in similar plants in the area,
* historic & predicted weather event in the area
